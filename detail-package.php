      ...
      <section class="blog section" id="blog">
        <div class="blog__container container">
                    ...
                    <table class="detail-table">
                        <tr>
                            ...
                            <?php
                              ...
                              <td>Rp <?= number_format($row['harga_paket'], 0, '.', '.') ?>,-/Jeep</td>
                            <?php
                            }
                            ?>
            ...
            <h3 style="text-align: center;">Booking Now</h3>
              ...
              ?>
              <h4 style="text-align: center;"><?= $new_id ?></h4>
              <div class="card">
                <form action="" method="POST">
                  
                  <input type="text" name="nama" placeholder="Your Name" required />
                  <input type="email" name="email" placeholder="Your Email" required />
                  <input type="number" name="hp" placeholder="Your Number" required />
                  ...
                  <input type="number" name="jml" placeholder="Jumlah Orang" max= <?= $row['jenis_paket'] = 'private'? "6":"10"; ?> required/>
                  <input type="text" name="harga" value="<?= $row['harga_paket'] ?>" readonly>
...
if (isset($_POST['pesan'])){
  ...
  $hp = $_POST['hp'];
  $point = $_POST['point'];
  $jumlah_orang = $_POST['jml'];
  $harga = $_POST['harga'];
  if ($row['jenis_paket'] == 'open'){
    $total_harga = $jumlah_orang * $harga;
  }else {
    $total_harga = $harga;
  }
  ...
  // QUERY DATA BOOKING
  $sql2 = "INSERT INTO booking VALUES ('$id_booking', '$id_paket', '$nama', '$email', '$hp', '$point', '$jumlah_orang', '$total_harga', '$catatan', 'belum bayar')";
