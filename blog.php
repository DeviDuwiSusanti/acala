...
<body>
  ...
  <main class="main">
    ...
    <section class="blog section" id="blog">
      <div class="blog__container container">
          <span class="section__subtitle" style="text-align: center">About Event</span>
      ...
      <?php
        while ($row = mysqli_fetch_assoc($query)) { ?>
            <div class="event-container">
                <div class="event-row">
                    <div class="event-image-column col-md-6">
                        <img src="<?= $row['image'] ?>" alt="" class="event-image">
                    </div>
                    <div class="event-details-column col-md-6">
                        <p class="event-title"><b><?= $row['nama_event'] ?></b></p>
                        <p class="event-description"><?= $row['deskripsi_event'] ?></p>
                        <p class="event-date"><b>Save The Date: <?= $row['tanggal_event'] ?></b></p>
                    </div>
                </div>
            </div>
        <?php
